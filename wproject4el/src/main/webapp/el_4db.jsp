...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<jsp:useBean id="s connCla" class="w test.ConnCla" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<table border="1">
	  ...
	  <tr>
	  	<td><$s.code></td> <%--getter를 부르는 EL --%>
	  	<td><$s.sang></td> <%--getter를 부르는 EL --%>
	  	<td><$s.su></td> <%--getter를 부르는 EL --%>
	  	<td><$s.dan></td> <%--getter를 부르는 EL --%>
	  </tr>
	  </c:forEach>
</table>
</body>
