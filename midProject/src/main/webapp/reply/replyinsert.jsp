...
//System.out.print(request.getParameter("reply_book_no"));
%>
<!DOCTYPE html>
<html>
<head>
...
<br><br>
인증사진 : <input type="file" name="reply_image"><br>
<br><br>
<input type="button" class="btnOk" value="리뷰등록" onClick="check()"/>
<input type="button"  value="목록으로"  onClick="location.href='../bookview/view.jsp'"/>
