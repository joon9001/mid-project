...
public class Ex45Swing extends JFrame implements ActionListener{
	...
	public Ex45Swing() {
		...
		panel.setLayout(new GridLayout(2, 1)); // 2행 1열로 나누어진 layout
		panel.setBorder(BorderFactory.createEmptyBorder(30, 30, 10, 30));
		// top, left, bottom, right 여백
		
		JButton button = new JButton("클릭(c)");
		button.setMnemonic(KeyEvent.VK_C); 
		// Mnemonic key - alt+C 단축키로 버튼 클릭 가능, 단축키 기능은 swing에서만 가능
		...
		// addWindowListener(....); Swing은 윈도우 종료를 아래와 같이 적을 수 있다.
